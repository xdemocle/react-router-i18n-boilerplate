        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8 mb-12'>
          <div className='col-span-1 md:col-span-2'>
            <Link to='/' className='flex items-center mb-4'>
              ...
              <span className='text-2xl font-display font-bold'>
                <span className='text-primary-500'>react-router-i18n</span>
          ...
          <div>
            ...
            <div className='flex space-x-4 mb-6'>
              ...
              <a
                href='https://facebook.com/react-router-i18n-boilerplate'
                target='_blank'
                rel='noreferrer'
                aria-label='Facebook'
                className='w-10 h-10 flex items-center justify-center rounded-full bg-neutral-800 text-neutral-400 hover:bg-primary-500 hover:text-white transition-colors duration-200'
              ...
              <a
                href='https://instagram.com/react-router-i18n-boilerplate'
                target='_blank'
                rel='noreferrer'
              ...
              <a
                href='https://linkedin.com/company/react-router-i18n-boilerplate'
                target='_blank'
                rel='noreferrer'
                aria-label='LinkedIn'
                className='w-10 h-10 flex items-center justify-center rounded-full bg-neutral-800 text-neutral-400 hover:bg-primary-500 hover:text-white transition-colors duration-200'
            ...
            <div className='space-y-2'>
              <a
                href='mailto:hello@react-router-i18n-boilerplate'
              ...
              >
                ...
                hello@react-router-i18n-boilerplate
              </a>
              <a
        ...
        <div className='border-t border-neutral-800 pt-8 pb-4'>
          <div className='flex flex-col md:flex-row justify-between'>
            <p className='text-neutral-500 text-sm mb-4 md:mb-0'>
              &copy; {currentYear} react-router-i18n-boilerplate.{' '}
